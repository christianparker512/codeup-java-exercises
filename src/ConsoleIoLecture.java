...
//                There was not a new line. all the words were right next to one another.
        // >>>> Multiple Variables
        ...
        System.out.printf("hello%n", three, typeOfPet);
...
//        Java organiz4s code through packages, which we have to import.
//        Import statements let us code from try {
//            other packagesThey go at the top of your () -> file

//      automated imports for intelliJ option.enter
