...
//        ArrayList<String> categories = new ArrayList<>();
        ArrayList<String> categories = new ArrayList<>(Arrays.asList("Beverages","Bread/Baker","Canned/Jarred Goods", "Dairy","Baking Goods","Frozen Goods","Meat", "Produce","Other"  ));
...
//        categories.add("Other");
    ...
    public static int groceryListQuantity(Input prompt) {
    ...
    public static void addList(HashMap<Integer, Grocery> shoppingList, int count, ArrayList<String> array, Input prompt) {
        ...
        shoppingList.get(count).setQuantity(groceryListQuantity(prompt));
        Input response = new Input();
